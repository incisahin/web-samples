                  ...
                  <div class="col-md-12">
                    <form method="post" action="" class="form-horizontal form-label-left">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <?php 
                          $Sorgu = $db->prepare("SELECT * FROM site_sosyalmedya ");
                          $Sorgu->execute(array( ));
                            ...
                            foreach ( $Sorgu as $key => $value ) {
                              ...
                              <form method="post">
                                <tr>
                                  ...
                                  <td class="dark">
                                    <b class="pull-right"><?=$value->DegerOnEki?></b>
                                  </td>
                                  <td class="dark">
